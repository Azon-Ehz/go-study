...
type Response struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Replay        string                 `protobuf:"bytes,1,opt,name=replay,proto3" json:"replay,omitempty"` //1是编号 不是值
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Response) GetReplay() string {
	if x != nil {
		return x.Replay
	}
	return ""
...
const file_helloworld_proto_rawDesc = "" +
	...
	"\bResponse\x12\x16\n" +
	"\x06replay\x18\x01 \x01(\tR\x06replay2G\n" +
	"\fHelloService\x127\n" +
	"\x05Hello\x12\x18.helloworld.HelloRequest\x1a\x14.helloworld.ResponseB+Z)awesomeproject/helloword/proto;helloworldb\x06proto3"
...
var file_helloworld_proto_depIdxs = []int32{
	0, // 0: helloworld.HelloService.Hello:input_type -> helloworld.HelloRequest
	1, // 1: helloworld.HelloService.Hello:output_type -> helloworld.Response
